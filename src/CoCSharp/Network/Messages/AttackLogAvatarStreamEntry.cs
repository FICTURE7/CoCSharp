...
{
    /// <summary>
    /// Stream entry sent to give the client information about an attack log
    /// entry.
    /// </summary>
    public class AttackLogAvatarStreamEntry : AvatarStreamEntry
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttackLogAvatarStreamEntry"/> class.
        /// </summary>
        public AttackLogAvatarStreamEntry()
        {
            // Space
        }
        ...
        /// <summary>
        /// Reads the <see cref="AttackLogAvatarStreamEntry"/> from the specified <see cref="MessageReader"/>.
        /// </summary>
        /// <param name="reader">
        /// <see cref="MessageReader"/> that will be used to read the <see cref="AttackLogAvatarStreamEntry"/>.
        /// </param>
        ...
        /// <summary>
        /// Writes the <see cref="AttackLogAvatarStreamEntry"/> to the specified <see cref="MessageWriter"/>.
        /// </summary>
        /// <param name="writer">
        /// <see cref="MessageWriter"/> that will be used to write the <see cref="AttackLogAvatarStreamEntry"/>.
        /// </param>
        ...
        /// <summary>
        /// Extension of <see cref="AttackLogAvatarStreamEntry"/>.
        /// </summary>
