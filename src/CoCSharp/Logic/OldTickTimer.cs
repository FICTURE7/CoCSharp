...
namespace CoCSharp.Logic
{
    ...
    public class OldTickTimer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OldTickTimer"/> class.
        /// </summary>
        public OldTickTimer()
        {
            // Space
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="OldTickTimer"/> is active.
        /// </summary>
        public bool IsActive => _isActive;

        /// <summary>
        /// Gets the time when the <see cref="OldTickTimer"/> was started in the UNIX epoch time.
        /// </summary>
        public int StartTime => _startTime;

        /// <summary>
        /// Gets the time at which the <see cref="OldTickTimer"/> will complete in the UNIX epoch time.
        /// </summary>
        /// 
        /// <remarks>
        ...
        /// <summary>
        /// Gets the remaining time until the <see cref="OldTickTimer"/> will complete in seconds.
        /// </summary>
        /// 
        /// <remarks>
        ...
        /// <summary>
        /// Stops the <see cref="OldTickTimer"/>.
        /// </summary>
        public void Stop()
        {
            _isActive = false;
        ...
        /// <summary>
        /// Determines whether or not the <see cref="OldTickTimer"/> has completed using the specified
        /// tick.
        /// </summary>
        /// <param name="tick">Tick at which to check whether the <see cref="OldTickTimer"/> has completed.</param>
        /// <returns><c>true</c> if the <see cref="OldTickTimer"/> has completed; otherwise <c>false</c>.</returns>
